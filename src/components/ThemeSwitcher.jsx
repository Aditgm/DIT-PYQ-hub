...
const ThemeSwitcher = ({ className = '' }) => {
  ...
  return (
    ...
    >
      ...
      {!isLight && (
        <svg className="h-5 w-5 text-on-surface" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Moon icon for dark mode (showing when currently light) */}
      {isLight && (
        <svg className="h-5 w-5 text-on-surface" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
