-- =============================================
-- SUPABASE SQL MIGRATIONS - PAPER METADATA EDITING
...
CREATE INDEX idx_paper_versions_edited_by ON paper_versions(edited_by);
...
ADD COLUMN paper_id UUID REFERENCES papers(id),
...
-- Creates version 1 for all existing papers
-- =============================================
